...
// webpcss = require("gulp-webpcss") временно не работает
...
function css() {
  return (
    src(path.src.css)
      ...
      // .pipe(webpcss()) временно не работает
    ...
    svgSprite({
      mode: {
        stack: {
          ...
          // раскоментировать строку example запустить galp
          // открыть второй терминал и ввести команду gulp svgSprite
          //example: true
        },
      },
    })
